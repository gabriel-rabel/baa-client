    ...
    async function validateToken() {
      try {
        ...
        const response = await api.get(
          `/business/reset-password/valid-token/${token}`
        );
  ...
  async function handleSubmit(e) {
    ...
    try {
      if (newPassword === newPassword2) {
        await api.put(`/business/new-password/${token}`, {
              ...
              <div className="w-full max-w-sm p-8">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="flex flex-col">
                    <div>
                    <p className="text-xs leading-3 text-gray-400">Atenção: Sua nova senha deve conter pelo menos uma letra Maiúscula A-Z e um caractere especial @#$%&.</p>
                    </div>
                    <div>
                    <button
                      type="submit"
